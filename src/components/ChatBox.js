  ...
  return (<>
    {
      auth &&
      <>
        <main className='min-h-screen m-2 flex flex-col items-center mb-24 bg-gray-700 min-w-full'>
          <h1 className=' text-white text-2xl'>Channel name</h1>
          <div className='min-h-screen min-w-full m-6 mt-4 border-2 shadow-lg mb-5 shadow-white border-cyan-300 p-3 rounded-xl h-96 overflow-y-scroll w-3/5 max-w-6xl scrollbar-none'>
            ...
            {
              messages?.length <= 0 && <h1 className='text-white text-2xl text-center'>chat with everyone</h1>
            }
